...
--- @param cmd function|string: The command to be executed when the key is pressed
--- @param desc string|nil: The options for the keymap (optional)
--- @param opts table|nil: The options for the keymap (optional)
function M.map(mode, key, cmd, desc, opts) vim.keymap.set(mode, key, cmd, opts or { noremap = true, silent = true, desc = desc or "" }) end
